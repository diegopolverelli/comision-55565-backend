...
app.get('/token',(req,res)=>{
    ...
    let token=jwt.sign({usuario}, "secret2023")
...
await mongoose.connect('mongodb+srv://coderhouse:coderhouse@cluster0.5rl5n6j.mongodb.net/?retryWrites=true&w=majority&dbName=clase38')
