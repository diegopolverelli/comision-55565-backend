...
import { validaHeroe } from '../utils/heroesErrores.js';
...
router.post('/',(req,res)=>{
    ...
    if(!name){
        ...
        throw CustomError.CustomError("Faltan datos","Ingrese la propiedad name", tiposDeError.ERROR_ARGUMENTOS_INVALIDOS, validaHeroe(req.body))
    }
